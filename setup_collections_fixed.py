...
def main():
    ...
    # First create basic collections without relations
    basic_collections = [
        {
            "name": "customers",
            "type": "base",
    ...
    # Create basic collections first
    for collection in basic_collections:
        create_collection(token, collection)
    
    # Get collection IDs
    existing_collections = get_collections(token)
    print(f"Existing collections: {existing_collections}")
    
    # Now create collections with relations
    if "vendors" in existing_collections and "customers" in existing_collections:
        vendor_id = existing_collections["vendors"]
        customer_id = existing_collections["customers"]
        
        relations_collections = [
            {
                "name": "inventory",
                "type": "base",
                "schema": [
                    ...
                    {"name": "vendor", "type": "relation", "options": {"collectionId": vendor_id, "cascadeDelete": False}},
            ...
            },
            {
                ...
                "schema": [
                    ...
                    {"name": "customer", "type": "relation", "options": {"collectionId": customer_id, "cascadeDelete": False}},
        ...
        for collection in relations_collections:
            create_collection(token, collection)
