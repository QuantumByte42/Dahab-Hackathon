...
export function EnhancedSales() {
  ...
  const addItemToSale = () => {
    ...
    const newItem: SaleItem = {
      ...
      weight_grams: Number.parseFloat(currentItem.weight_grams),
      karat: Number.parseInt(currentItem.karat),
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setCurrentItem({ ...currentItem, item_type: value })}
                >
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setCurrentItem({ ...currentItem, weight_grams: e.target.value })}
                  placeholder="5.20"
                />
              </div>
              <div className="space-y-2">
